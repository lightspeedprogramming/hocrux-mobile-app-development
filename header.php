    ...
    <body>
		...
		<nav class="navbar navbar-expand-lg">
            ...
            <a class="logo" href="#">
			  ...
			  <button style="padding-top: 25px;" class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
			    <span class="icon-bar"><i class="fas fa-bars"></i></span>
			  </button>

			  <!-- navbar links -->
			  <div style="padding-top: 20px;" class="collapse navbar-collapse" id="navbarSupportedContent">
